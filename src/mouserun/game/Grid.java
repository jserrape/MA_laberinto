 ...
 * four walls that defines the possible directions to move from the Grid to the
 * next. The construction of the Maze uses a Depth-First Search algorithm. In a
 * graph, Grid will be the vertex.
 */
public class Grid {
    ...
    /**
     * Based on the configuration of the grid, this will return the asset name
     * that will display this grid.
     *
