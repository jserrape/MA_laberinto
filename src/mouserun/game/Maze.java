...
/**
 * Class Maze is the board which the Mouse implementations will navigate through
 * to find the Cheese.
 */
public class Maze {
    ...
    /**
     * Creates a new instance of the maze. The maze will automatically build the
     * layout given the width and the height of the maze.
     *
